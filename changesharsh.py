...
def speech_reg():
   ...
   sprs.resizable(0,0)
   b_1=Button(sprs,text="Google speech Recognition Software",width=36)
   b_1.pack()
   b_2=Button(sprs,text="Web page Speech Recognition(Recommended)",command=web)
   b_2.pack()
def clear():
...
def t_u():
   ...
   L7.config(text='Problem'+'('+translator.translate('Problem',dest='ur').text+')')
...
def filling():
   o=0
   global lan,p_name,weight,gender,age,p_no,prob,medi,name,problem,list1,entry3,entry0,pn_p_e,p_a_e,pn_w_e,Text1,Text2,text
   print(text)
   while o<len(text):
      print('ok')
      if(text[o]=="name"):
   ...
   p_no=''.join(p_no)
   print(prob)
   for i in ['next','another']:
      if i in prob:
         try:
            problem=' '.join(prob).split(' next problem ')
            break
         except:
            problem=' '.join(prob).split(' next ')
            try:
               problem=' '.join(prob).split(' another problem ')
            except:
               problem=' '.join(prob).split(' another ')
   problem='\n'.join(problem)
   #medicine=' '.join(medi)
   i=0
   tablets=[]
...
def first_window(event=0):
   ...
   #frame2.config(width=350,height=325)
...
def new_patient():
   f_window.destroy()
   global window,lan,p_name,weight,gender,age,p_no,prob,medi,name,problem,list1,entry3,entry0,pn_p_e,p_a_e,pn_w_e,Text1,Text2,text,p_a,pn_p,pn_w,L6,L5,L4,L7,L8
   window=Tk()
   ...
   f1=Frame(window,bg='#ff8484')
   f0=Frame(window,bg='#ff8484')
   ...
   f1.configure(background='#ff8484')
   #wl_4=Label(f1,text="  ",bg='#ff8484').pack(side='right')
   b4_1=Button(f1,text="Select Speech recognition software",borderwidth=4,command=speech_reg,font=("Ariel",14))
   b4_1.pack(side='right')
   ...
   #menubar.add_cascade(label=back_image,menu=set_speech)
   ...
   L4=Label(f3,bg='#ff8484',text="Enter Patient's detials:",font=("Ariel",16))
   L4.pack(side='left')
   #L1.pack(side='left')
   f3.pack(side=TOP,fill='x')
   f4=Frame(window)
   ...
   L6=Label(f4,bg='#ff8484',text="Gender:             ",font=("Ariel",14))
   L6.pack(side='left')
   ...
   b1=Button(f10,text='START',command=speak,font=("Ariel",14)).pack(side='left')
   '''wl_1=Label(f10,text="  ",bg='#ff8484').pack(side='left')
   b1=Button(f10,text='Stop',command=web_c).pack(side='left')'''
   wl_1=Label(f10,text="  ",bg='#ff8484').pack(side='left')
   b2=Button(f10,text='Edit with Speech',command=make_changes,font=("Ariel",14)).pack(side='left')
   wl_2=Label(f10,text="  ",bg='#ff8484').pack(side='left')
   b3=Button(f10,text='CLEAR',command=clear,font=("Ariel",14)).pack(side='left')
   l_w=Label(f10,text='   ',bg='#ff8484').pack(side='right')
   b4=Button(f10,text='Add Signature',command=add_sign,font=("Ariel",14))
   b4.pack(side='right')
   f10.pack(fill='x')
   path=''
   f21_w=Frame(window)
   ...
   b6=Button(f21,text="CREATE PDF",command=pdf,font=("Ariel",14))
   b6.pack(side='left')
   l6_1=Label(f21,text=' ',bg='#ff8484').pack(side='left')
   b6_1=Button(f21,text='Open pdf',command=open_pdf,font=("Ariel",14))
   b6_1.pack(side='left')
   l6_1=Label(f21,text=' ',bg='#ff8484').pack(side='left')
   b6_2=Button(f21,text='Send pdf via Whatsapp',command=send_wapps,font=("Ariel",14))
   b6_2.pack(side='left')
   f21.pack(fill='x')
   fclose=Frame(window,bg='#ff8484')
   btn_cls=Button(fclose,text='Close',command=first_window,font=("Ariel",14))
   btn_cls.pack()
   fclose.pack()
   window.mainloop()
window=0

...
def make_changes():#Edit with Speech BUTTON
   lan='en-IN'
   r=sr.Recognizer()
   mic=sr.Microphone()
   with mic as source:
...
def get_h():#Reset Hospital's Details BUTTON
    ...
    try:
        ...
        pass
    window_h.mainloop()
def get_d():#Reset Doctor's Details BUTTON
    global window_d
    def display(EVENT=0):
      global window_d
